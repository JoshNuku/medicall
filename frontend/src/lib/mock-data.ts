...
export const MOCK_PATIENTS: Patient[] = [
  {
    ...
    current_medication_name: 'Amoxicilin 500mg',
  ...
  30: [
    {
      ...
      assembled_twi: 'Fa wo nnuro Amoxicilin 500mg. Fa baa baako. da biara mprɛnsa. adidie akyi. Mia nkron sɛ wopɛ sɛ wotie bio, anaa mia hwee ma wo duruyɛfoɔ.',
